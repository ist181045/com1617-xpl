...
void xpl::type_checker::do_funcdecl_node(xpl::funcdecl_node * const node, int lvl) {}
...
void xpl::type_checker::do_position_node(xpl::position_node * const node, int lvl) {}
